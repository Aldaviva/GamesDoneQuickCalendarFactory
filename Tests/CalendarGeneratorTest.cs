...
public class CalendarGeneratorTest {
    ...
    public async Task generateCalendar() {
        ...
        actualEvent.Uid.Should().Be("2/AGDQ2024/TUNIC/Any% Unrestricted — PC");
        ...
        actualEvent.Uid.Should().Be("2/AGDQ2024/Super Monkey Ball/Master — Wii");
        ...
        actualEvent.Uid.Should().Be("2/AGDQ2024/Donkey Kong Country/101% — SNES");
        ...
        actualEvent.Uid.Should().Be("2/AGDQ2024/Final Fantasy V Pixel Remaster/Any% Cutscene Remover — PC");
